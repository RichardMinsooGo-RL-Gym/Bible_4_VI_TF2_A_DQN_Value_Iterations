...
DISCOUNT = 0.95
max_episodes = 10000  # Number of iterations episode
...
if __name__ == "__main__":
    ...
    for episode in range(max_episodes):
        ...
        while not done:
            ...
            next_state, reward, done, _ = env.step(action)  # perform action on enviroment

            newDiscreteState = get_discrete_state(next_state, bins, obsSpaceSize)
        ...
        if episode % UPDATE_EVERY == 0:
            ...
            print("Episode:", episode, "Average:", averageCnt, "Min:", min(latestRuns), "Max:", max(latestRuns))
